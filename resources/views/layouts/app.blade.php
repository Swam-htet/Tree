...
<head>
    ...
    <!--fontawesome kit -->
    <script src="https://kit.fontawesome.com/70b68b584c.js" crossorigin="anonymous"></script>
...
<div id="app">
                    ...
                    @else
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                ...
                                {{-- Need Profile Route Here Gay toe --}}
    ...
    <footer class="bg-light shadow text-dark text-center text-lg-start">
        ...
        <div class="container p-4">
            <!--Grid row-->
            <div class="row mb-3">
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem saepe fugiat possimus quisquam esse
                    aliquam sapiente sunt commodi distinctio. Soluta quam quo modi unde eveniet neque aut at temporibus
                    minus.</p>
            </div>
            <div class="row">
                <!--Grid column-->
